...
static const char *fonts[]          = { "Iosevka Nerd Font:size=11", "Font Awesome 5 Free Solid" };
...
/* tagging */
static const char *tags[] = { "CODE", "WEB", "HOME", "MUS", "CHAT", "FUN", "FILE", "GFX", "EDU" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("rofi -show drun -theme ~/.config/rofi/bruh.rasi -show-icons") },
